  ...
  return (
    <>
      ...
      <div className="flex justify-center w-full  relative ">
        <div className="w-[92%] md:w-[75%] lg:w-[65%] xl:w-[75%] ">
          <div className="pb-5">
          ...
          <div>
            <div className="flex flex-col-reverse lg:flex-row lg:gap-10">
              ...
              {/* right side */}
              <div className="h-fit flex justify-end w-[45%] ">
                <div className="flex flex-col gap-2 overflow-hidden  bg-muted rounded-md">
